...
const adminUpdater = fs.readFileSync("./__QQBOT/admin-list.txt",function(err, data){ 
  console.info("admin_list 已更新")
  admin_list = data.toString().split("\n");
})
const groupUpdater = fs.readFileSync("./__QQBOT/controlled-group.txt",function(err, data){ 
