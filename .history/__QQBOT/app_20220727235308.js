...
client.on("message.group", e => {
  ...
  if (admin_list.match(e.user_id.toString())[0] != e.user_id.toString()) {e.reply("Access denied: You dont have permission to execute this command", true);console.log() return;}
