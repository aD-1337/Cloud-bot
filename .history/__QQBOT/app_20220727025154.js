...
client.on("message", e => {
  ...
  if (e.message.type != "text") {console.log("1"); return};
  if (e.sub_type != 'normal') {console.log("1"); return};
  if (post_type != 'message') {console.log("1"); return};
  if (e.block == true) {console.log("1"); return};
  if (e.atall == true) {console.log("1"); return};

  if (admin_list[e.sender.user_id] == undefined) {console.log("1"); return};
  if (group_list[e.group_id] == undefined) {console.log("1"); return};
