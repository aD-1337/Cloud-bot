...
client.on("message", e => {
  //合法性检查
  console.log(e)
  if (e.message_type != "group") {console.log("this message isnt from a group"); return};
  if (e.message[0].type != "text") {console.log("this message isnt a text"); return};
  if (e.sub_type != 'normal') {console.log("this message are not normal"); return};
  if (post_type != 'message') {console.log("this message isnt a message"); return};
